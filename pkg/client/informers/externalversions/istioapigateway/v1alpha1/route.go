...
import (
	...
	v1alpha1 "knative.dev/net-istio-api-gateway/pkg/client/listers/istioapigateway/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IstioapigatewayV1alpha1().Routes(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IstioapigatewayV1alpha1().Routes(namespace).Watch(options)
			},
		},
		&istioapigatewayv1alpha1.Route{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&istioapigatewayv1alpha1.Route{}, f.defaultInformer)
}
