...
type FakeRoutes struct {
	Fake *FakeIstioapigatewayV1alpha1
	ns   string
}

var routesResource = schema.GroupVersionResource{Group: "istioapigateway.knative.dev", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "istioapigateway.knative.dev", Version: "v1alpha1", Kind: "Route"}
