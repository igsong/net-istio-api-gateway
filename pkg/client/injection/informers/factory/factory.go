...
import (
	...
	externalversions "knative.dev/net-istio-api-gateway/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/net-istio-api-gateway/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
