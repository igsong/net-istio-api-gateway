...
import (
	...
	route "knative.dev/net-istio-api-gateway/pkg/client/injection/reconciler/istioapigateway/v1alpha1/route"
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.Route) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.Route) reconciler.Event {
